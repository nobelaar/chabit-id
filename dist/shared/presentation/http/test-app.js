...
export function createTestApp() {
    ...
    app.route('/auth', createCredentialRoutes(signIn, refreshToken, revokeToken, changePassword, revokeAllTokens, changeUsername, resetPassword, requestVerification));
    app.route('/accounts', createAccountRoutes(requestOrganizer, approveOrganizer, rejectOrganizer, reRequestOrganizer, getAccountsByIdentity));
